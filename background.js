...
chrome.contextMenus.onClicked.addListener(function (clickData) {
  //only create the context menu item if field is editable and the there's selected text
  if (document.activeElement.isContentEditable && clickData.selectionText) {
    chrome.contextMenus.create(contextMenuItem);
